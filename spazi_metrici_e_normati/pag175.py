...
r3 = patches.Rectangle((-1, -1), 2, 2, angle=0, edgecolor=(0, 1, 0, 1), facecolor=(0, 0, 0, 0))
...
#Add text
ax1.text(.75, -.75, r"$B_{\frac{r}{\sqrt{2}}} (0) \times B_{\frac{r}{\sqrt{2}}} (0)$", color="b")
ax1.text(.8, 0, r"$r$", color="r")
ax1.text(1, 1, r"$B_{r}(0) \times B_{r}(0)$", color="g")
